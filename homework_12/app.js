...
var detailPage = function (obj) {
    ...
    div_Table.innerHTML = "Characteristic"
    var table = creator("table","table");
    table.innerHTML = "<tr><td>damage</td><td>" + obj.details.damage + "</td></tr>" +
    "<tr><td>breoning</td><td>" + obj.details.breoning + "</td></tr>" +
    "<tr><td>attack speed</td><td>" + obj.details.attack_speed + "</td></tr>" +
    "<tr><td>time of targeting</td><td>" + obj.details.time_of_targeting + "</td></tr>" +
    "<tr><td>ammunition</td><td>" + obj.details.ammunition + "</td></tr>";
